  ...
  return (
    <>
      <PageHeader
        eyebrow="Operations"
        title="CS Dashboard"
        description="Gorgias 3-panel rebuild + Lark Mail reconcile. Customer profile auto-join Shopify + Recharge."
      />

      <h2 id="why">Vì sao rebuild khỏi Gorgias</h2>
      <div className="not-prose my-5 rounded-xl border bg-card p-4">
        <ul className="space-y-2 text-[13px] leading-6">
          <li className="flex items-start gap-2">
            <span className="text-muted-foreground mt-0.5">•</span>
            <div>
              <strong>Gorgias đắt</strong> với volume hiện tại — license tăng tuyến tính theo
              agent.
            </div>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-muted-foreground mt-0.5">•</span>
            <div>
              Team CS đã dùng <strong>Lark Mail</strong> làm primary inbox.
            </div>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-muted-foreground mt-0.5">•</span>
            <div>
              Cần auto-join customer profile (Shopify orders + Recharge subs + tracking) ở 1
              view.
            </div>
          </li>
        </ul>
        ...
        <div className="flex items-start gap-2">
          ...
          <div>
            ...
            <div className="text-[13px] leading-6 text-foreground/85">
              Đừng leave placeholder UI / dead clicks. CS team sẽ click thử và mất niềm tin.
